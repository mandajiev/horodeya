...
#    path('', views.IndexView.as_view(), name='index'),
    ...
    path('legal/create/', views.CommunityCreate.as_view(), name='legal_create'),
    path('legal/<int:pk>', views.CommunityDetails.as_view(), name='legal_details'),
    path('legal/<int:pk>/update', views.CommunityUpdate.as_view(), name='legal_update'),
    path('legal/<int:pk>/delete', views.CommunityDelete.as_view(), name='legal_delete'),
    path('legal/', views.CommunityList.as_view(), name='legal_list'),
    path('legal/<int:community_id>/members/add/', views.legal_member_add, name='legal_member_add'),
    path('legal/<int:community_id>/members/remove/<int:user_id>', views.legal_member_remove, name='legal_member_remove'),
    path('legal/<int:pk>/members', views.CommunityMemberList.as_view(), name='legal_member_list'),
