...
Променяме каквото си искаме, после

```
npm run css-compile-main css-prefix-main
npm run css-minify-main
npm run js-compile js-minify-main
```

Грешките не са ни проблем, CSS и JS файловете са готови в dist
